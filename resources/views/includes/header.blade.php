...
<div id="kt_app_header" class="app-header  d-flex flex-column flex-stack ">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        ...
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="https://preview.keenthemes.com/metronic8/demo39/index.html" class="app-sidebar-logo">
                <img alt="Logo"
                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/logos/demo39.svg"
                    class="h-25px theme-light-show" />
                <img alt="Logo"
                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/logos/demo39-dark.svg"
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
                    ...
                    <div data-kt-search-element="content"
                                ...
                                <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/svg/brand-logos/volicity-9.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/svg/brand-logos/tvit.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/svg/misc/infography.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/svg/brand-logos/leaf.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-40px me-4">
                                            <span class="symbol-label bg-light">
                                                <img class="w-20px h-20px"
                                                    src="https://preview.keenthemes.com/metronic8/demo39/assets/media/svg/brand-logos/tower.svg"
                                                    alt="" />
                                            </span>
                                        </div>
                                        <!--end::Symbol-->
                        ...
                        <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="https://preview.keenthemes.com/metronic8/demo39/utilities/search/horizontal.html"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                            ...
                            <div class="py-3 text-center border-top">
                                <a href="https://preview.keenthemes.com/metronic8/demo39/pages/user-profile/activity.html"
            ...
            <div class="app-navbar-item ms-2 ms-lg-6">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                    ...
                    <div class="row g-0">
                        ...
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://preview.keenthemes.com/metronic8/demo39/apps/projects/list.html"
                                class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
                                <i class="ki-outline ki-abstract-41 fs-3x text-primary mb-2"></i> <span
                                    class="fs-5 fw-semibold text-gray-800 mb-0">HRM</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        ...
                        {{-- <!--begin:Item-->
                        <div class="col-6">
                            <a href="https://preview.keenthemes.com/metronic8/demo39/apps/projects/users.html"
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                    ...
                    <div class="menu-item px-5">
                        <a href="https://preview.keenthemes.com/metronic8/demo39/account/overview.html"
                    ...
                    <div class="menu-item px-5 my-1">
                        <a href="https://preview.keenthemes.com/metronic8/demo39/account/settings.html"
                            class="menu-link px-5">
                            Account Settings
                        </a>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <a class="menu-link px-5" href="javascript:;" onclick="parentNode.submit();">
                               Sign out
                            </a>
                        </form>
                    </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-6">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" href="javascript:;" onclick="parentNode.submit();">
